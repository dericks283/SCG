...
{
    public partial class DCTurma : Form
    {
        ...
        {
            #region
            if (txtTurma.Text == "Nome da Turma:" || cbModalidades.Text == "Modalidade" || txtHorario.Text == "__:__") { MessageBox.Show("Campos vazios, verifique os valores correspondentes e tente novamente!"); }
            else
            {
                #endregion
                if (cbModalidades.Text == "Basquete")
        ...
        private void cbModalidades_DropDown(object sender, EventArgs e)
        {
            btnAtualizar.Enabled = false;
            btnExcluir.Enabled = false;
        }

        private void DCTurma_Load(object sender, EventArgs e)
        {
           
        }

        private void txtIdTurmas_TextChanged(object sender, EventArgs e)
        {
